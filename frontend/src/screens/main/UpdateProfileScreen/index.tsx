...
const UpdateProfileScreen = () => {
  ...
  const { user, isUpdatingProfile } = useUser({ refetchOnMount: false });
  ...
  return (
    <ScreenWrapper>
      ...
      <Paragraph style={styles.text}>
        Aqui você pode alterar seu nome e telefone. Lembre-se, a data de
        nascimento e o gênero são obrigatórios para calcular corretamente as
        suas calorias.
      </Paragraph>
      <ProfileForm
